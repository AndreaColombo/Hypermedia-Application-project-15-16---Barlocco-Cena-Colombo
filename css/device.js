               ...
               // div section in the same page.
				...
				ajaxRequest.onreadystatechange = function(){
					if(ajaxRequest.readyState == 4){
						...
						$("#div-col-0").append("<a href='#'><div class = 'device-page-subtitle' id = 'smartphone1'>All</div></a>");
						for (i=7, j=1; i<11; i++, j++){
							$("#div-col-0").append("<a href='#'><div class = 'device-page-subtitle' id = 'smartphone1'>"+x[i].subcategory+"</div></a>");
						}
						$("#div-col-1").append("<a href='#'><div class = 'device-page-subtitle' id = 'smartphone1'>All</div></a>");
						for (i=11, j=1; i<13; i++, j++){
							$("#div-col-1").append("<a href='#'><div class = 'device-page-subtitle' id = 'smartphone1'>"+x[i].subcategory+"</div></a>");
						}
						$("#div-col-2").append("<a href='#'><div class = 'device-page-subtitle' id = 'smartphone1'>All</div></a>");
						for (i=13, j=1; i<15; i++, j++){
							$("#div-col-2").append("<a href='#'><div class = 'device-page-subtitle' id = 'smartphone1'>"+x[i].subcategory+"</div></a>");
						}
						$("#div-col-3").append("<a href='#'><div class = 'device-page-subtitle' id = 'smartphone1'>All</div></a>");
						for (i=15, j=1; i<18; i++, j++){
							$("#div-col-3").append("<a href='#'><div class = 'device-page-subtitle' id = 'smartphone1'>"+x[i].subcategory+"</div></a>");
						}
